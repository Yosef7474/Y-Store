      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="bg-white shadow-xl rounded-2xl overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            {/* Contact Information */}
            <div className="bg-gray-50 py-10 px-6 sm:p-10">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-500">+251923456789</p>
                    <p className="text-sm text-gray-500">Mon-Fri 9am-6pm GMT +3 </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-500">support@shopflow.com</p>
                    <p className="text-sm text-gray-500">help@shopflow.com</p>
                  </div>
                </div>
